...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "bautista-s-bazaar-jheyp.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "2de926eb78c74b685bf565b23e9eefcb";
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    toast.error("Shopify: pago requerido", {
      description: "El acceso a la API requiere un plan activo. Visitá https://admin.shopify.com",
    });
    return;
  }
