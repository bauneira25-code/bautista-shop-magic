...
export const CATEGORY_THEMES: Record<string, CategoryTheme> = {
  todo: {
    ...
    emoji: "✨",
    icon: LayoutGrid,
    bg: "linear-gradient(180deg, #0a0612 0%, #15091f 50%, #0a0612 100%)",
    surface: "linear-gradient(135deg, rgba(168,85,247,0.10), rgba(236,72,153,0.05))",
    accent: "#a855f7",
    accent2: "#ec4899",
    textOn: "#0a0612",
    font: "font-display",
  ...
  tech: {
    id: "tech",
    name: "Tecnología",
    tagline: "Entrá al mundo IA",
    emoji: "📱",
    icon: Cpu,
    bg: "linear-gradient(180deg, #020617 0%, #051045 50%, #020617 100%)",
    surface: "linear-gradient(135deg, rgba(56,189,248,0.10), rgba(124,58,237,0.05))",
    accent: "#22d3ee",
    accent2: "#3b82f6",
    textOn: "#020617",
    font: "font-mono",
    pattern: "circuit",
    vibe: "// SYSTEM ONLINE",
    badges: ["NEW DROP", "AI READY", "5G", "PRO"],
    cta: "Comprar ahora →",
  },
  hogar: {
    id: "hogar",
